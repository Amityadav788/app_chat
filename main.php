    ...
    <section class="msger">
        <header class="msger-header">
            ...
            <div class="msger-header-options">
                <span><a type="button" class="btn btn-submit" href="http://localhost/app_chat/logout.php">Logout</a></span>
            </div>
        </header>
        ...
        <?php foreach($output as $key => $value){ ?>
                ...
                <img class="img-circle" width="70" height="80" src= "../app_chat/uploads/<?php echo $value['image']; ?>"/>
                </div>
                ...
                <div class="msg-bubble">
                    <div class="msg-info">
                        <div class="msg-info-name"><?php echo $value['name']; ?></div>
                        <div class="msg-info-time">12:50</div>
                    </div>
